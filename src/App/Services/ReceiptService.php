...
class ReceiptService
{
    ...
    public function validateFile(?array $file)
    {
        ...
        //check the filename to make sure is valid and not containing weird characters ex: image$.jpg
        ...
        //check the file type is in the allowedType array 
    ...
    public function read(array $receipt)
    {
        ...
        header("Content-Disposition: inline; filename={$receipt['original_filename']}"); //inline tries to display use attachment to force download
